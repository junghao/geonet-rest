...
var routes = []routeTest{
	{
		...
		[]route{
			...
			{loc(), "/quake?regionID=newzealand&regionIntensity=weak&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=light&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=moderate&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=strong&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=severe&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=100&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=500&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=1000&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=1500&quality=best,caution,good"},
			{loc(), "/quake?regionID=aucklandnorthland&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=tongagrirobayofplenty&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=gisborne&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=hawkesbay&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=taranaki&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=wellington&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=nelsonwestcoast&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=canterbury&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=fiordland&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=otagosouthland&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
	...
	},
	{
		...
		[]route{
			{loc(), "/quake?regionID=newzealand&regionIntensity=bad&number=30&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=30&quality=best,caution,bad"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&number=999&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable&quality=best,caution,good"},
			{loc(), "/quake?regionID=newzealand&regionIntensity=unnoticeable"},
			{loc(), "/quake?regionID=newzealand"},
			{loc(), "/quake"},
			{loc(), "/quake?regionID=ruapehu&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/quake?regionID=bad&regionIntensity=unnoticeable&number=3&quality=best,caution,good"},
			{loc(), "/region/bad"},
